...
try:
    ...
    print(f"[OK] Image processed: {test_image_path}")
    print(f"[OK] Text extracted: {len(extracted_text)} characters")
    print(f"[OK] Device: {device_type.upper()}")
    print(f"[OK] Flash Attention: {flash_attn_status}")
